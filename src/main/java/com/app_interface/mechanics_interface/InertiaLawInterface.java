package main.java.com.app_interface.mechanics_interface;

import java.util.Scanner;
import main.java.com.mechanics.InertiaLaw;
...
public class InertiaLawInterface {
    ...
    public void inertia_law_mass_compute() {
        ...
        double force_value = MyUtils.enter_double("Enter force value in newton");
    ...
    public void inertia_law_force_compute() {
        ...
        double mass_value = MyUtils.enter_double("Enter mass value in kilogram");
        double acceleration_value = MyUtils.enter_double("Enter acceleration value in meters per square second");
