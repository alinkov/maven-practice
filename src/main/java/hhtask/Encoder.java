...
import hhtask.iofiles.CipherFile;
...
public final class Encoder {
    ...
    public static void main(final String[] args) {
        ...
        log.info("hhtask.Operation type: " + operation);
        try {
    ...
    private static void encryptFile(final String[] args) throws EncoderFileException {
        String plainPath = ArgumentsUtils.getPlainPath(args);
        if (plainPath == null) {
            log.error("Plain filepath not specified with " + Operation.ENCRYPT + " operation.");
    ...
    private static void decryptFile(final String[] args) throws EncoderFileException {
        String cipherPath = ArgumentsUtils.getCipherPath(args);
        if (cipherPath == null) {
            log.error("Cipher filepath not specified with " + Operation.DECRYPT + " operation.");
